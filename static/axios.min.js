!function (e, t) {
    ...
    var Ee = {
        http: null, xhr: "undefined" != typeof XMLHttpRequest && function (e) {
            return new Promise((function (t, n) {
                ...
                })), q.isUndefined(e.withCredentials) || (u.withCredentials = !!e.withCredentials), a && "json" !== a && (u.responseType = e.responseType), "function" == typeof e.onDownloadProgress && u.addEventListener("progress", we(e.onDownloadProgress, !0)), "function" == typeof e.onUploadProgress && u.upload && u.upload.addEventListener("progress", we(e.onUploadProgress)), (e.cancelToken || e.signal) && (r = function (t) {
    ...
    var xe = {
        ...
        return r(e, [{
            key: "request", value: function (e, t) {
                ...
                var n = t = Te(this.defaults, t), r = n.transitional, o = n.paramsSerializer, i = n.headers;
                void 0 !== r && xe.assertOptions(r, {
                    silentJSONParsing: Pe.transitional(Pe.boolean),
                    forcedJSONParsing: Pe.transitional(Pe.boolean),
                    clarifyTimeoutError: Pe.transitional(Pe.boolean)
                }, !1), null != o && (q.isFunction(o) ? t.paramsSerializer = {serialize: o} : xe.assertOptions(o, {
                    encode: Pe.function,
    ...
    var Le = function e(t) {
        ...
        return q.extend(r, Ue.prototype, n, {allOwnKeys: !0}), q.extend(r, n, null, {allOwnKeys: !0}), r.create = function (n) {
            return e(Te(t, n))
        }, r
    }(ae);
    return Le.Axios = Ue, Le.CanceledError = ye, Le.CancelToken = _e, Le.isCancel = me, Le.VERSION = je, Le.toFormData = G, Le.AxiosError = M, Le.Cancel = Le.CanceledError, Le.all = function (e) {
    ...
    }, Le.getAdapter = Oe, Le.HttpStatusCode = Be, Le.default = Le, Le
}));
